  ...
  if($preventExistingUser->rowCount()== 0 ){
    if($validateExistingUserDNI->rowCount()>0){
        ...
        if($passwordUser!=$confirmPasswordUser){
            echo '
            <div id="toast-danger" style=" display:flex;justify-content:center;"class="mx-auto flex items-center  p-4 mb-4 w-full max-w-xs text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" role="alert">
        ...
        echo '
        <div id="toast-danger" style=" display:flex;justify-content:center;"class="mx-auto mx-auto flex items-center  p-4 mb-4 w-full max-w-xs text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" role="alert">
        <div class="inline-flex flex-shrink-0 justify-center items-center w-8 h-8 text-red-500 bg-red-100 rounded-lg dark:bg-red-800 dark:text-red-200">
            <svg aria-hidden="true" class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
            <span class="sr-only">Error icon</span>
        </div>
...
<h3 class="mb-4 text-2x1 font-bold text-gray-900 dark:text-white">Registrarse a la plataforma</h3>

                    <div>
                        <label for="dni" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">DNI</label>
                        <input type="text" name="dni" id="dni" maxlength="8" minlength="8" type="text" placeholder="711022131" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" required>
                    </div>
                    <div>
                    ...
                    <div>
                        <label  for="cpass" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Confirmar tu contraseña</label>
                        <input oninput="this.value = this.value.replace(/\s/g, '')" type="password" name="cpass" id="cpass" placeholder="••••••••" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" required>
                    </div>
                    <div>
                        <label  for="token" class="block mb-2 flex gap-2 items-center text-sm font-medium text-gray-900 dark:text-white">
                            <span>Tu token<span>
                         ...
                         <div data-popover id="popover-tokenInfo" role="tooltip" class="absolute z-10 invisible inline-block text-sm font-light text-gray-500 transition-opacity duration-300 bg-white border border-gray-200 rounded-lg shadow-sm opacity-0 w-72 dark:bg-gray-800 dark:border-gray-600 dark:text-gray-400">
                                <div class="p-3 space-y-2">
                                <h3 class="font-semibold text-gray-900 dark:text-white">¿Que es esto?</h3>
                                ...
                                <h3 class="font-semibold text-gray-900 dark:text-white">¿Que sigue?</h3>
                        ...
                        <input type="text" name="token" id="token" placeholder="••••••••••••••" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" required>
                    </div>
