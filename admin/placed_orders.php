...
<section class="placed-orders">
   ...
   <h1 class="heading">Cotizaciones</h1>
   ...
   <div class="box">
      ...
      <p> Método de pago : <span><?= $fetch_orders['metodo_pago']; ?></span> </p>
      <p> Método de envío : <span><?= $fetch_orders['metodo_envio']; ?></span> </p>
      <form action="" method="POST">
         ...
         <div class="flex-btn">
            ...
            <a href="placed_orders.php?delete=<?= $fetch_orders['id']; ?>" class="delete-btn" onclick="return confirm('delete this order?');">Borrar</a>
         </div>
      </form>
   </div>
   <?php
