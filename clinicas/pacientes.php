    ...
    <div class="relative w-full h-full max-w-md md:h-auto">
        ...
        <div class="relative bg-white rounded-lg shadow ">
            ...
            <div class="px-6 py-6 lg:px-8">
                <h3 class="mb-4 text-xl font-medium text-gray-900 ">Nuevo Paciente</h3>
                  <a href="#" class="text-blue-600 flex gap-2 py-2 my-4   hover:no-underline" data-popover-target="popover-informacion-importante">
                ...
                <div data-popover id="popover-informacion-importante" role="tooltip" class="absolute z-10 invisible inline-block text-sm font-light text-gray-500 transition-opacity duration-300 bg-white border border-gray-200 rounded-lg shadow-sm opacity-0 w-96   ">
                    <div class="col-span-3 p-3">
                        <div class="space-y-2">
                            <h3 class="font-semibold text-gray-900 ">Sobre registro</h3>
                        ...
                        <div class=" mt-4 space-y-2">
                            <h3 class="font-semibold text-gray-900 ">Sobre token digital del paciente</h3>
                        ...
                        <div class=" mt-4 space-y-2">
                            <h3 class="font-semibold text-gray-900 ">Sobre información del paciente</h3>
                ...
                <form class="space-y-6" action="" method="post" >
                    <div> 
                        <label for="nombrePaciente" class="block mb-2 text-sm font-medium text-gray-900 ">Nombre(*)</label>
                        <input type="name" name="nombrePaciente" id="nombrePaciente" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5    " placeholder="Yess Espinoza" required>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="dni" id="dni" maxlength="8" minlength="8" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5    " placeholder="72789819" required>
                    </div>
                    <div>

                    <label for="telefonoPaciente" class="block mb-2 text-sm font-medium text-gray-900 ">Teléfono Whatsapp (*)</label>
                      <div class="flex gap-2 ">
                            <select id="telefonoPaciente" name="countryCode"  class="bg-gray-50    border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5    dark:text-black  ">
                              <?php
                              ...
                              <input type="tel"  name="telefonoPaciente" id="telefonoPaciente" maxlength="10" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5    " placeholder="913464044" >
                      
                      </div>
                    </div>
                    <div>
                        <label for="edadPaciente" class="block mb-2 text-sm font-medium text-gray-900 ">Edad</label>
                        <input type="number" max="120" name="edadPaciente" id="edadPaciente" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5    " placeholder="56" >
                    </div>
                    <div>
                        <label for="email" class="block mb-2 text-sm font-medium text-gray-900 ">Correo</label>
                        <input type="email"  name="email" id="email" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5    " placeholder="ejemplo@gmail.com" >
                    </div>
                    <div>
                        <label for="ciudadPaciente" class="block mb-2 text-sm font-medium text-gray-900 ">Ciudad</label>
                        <input type="location" name="ciudadPaciente" id="ciudadPaciente" placeholder="Cajamarca" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5    " >
                    </div>
                
                    <button type="submit" name="submitPacienteNuevo"class="w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center   ">Registrar</button>
                                    ...
                                    <div id="elimianrPacienteModal<?=$fetch_pacientes['id'] ;?>" tabindex="-1" aria-hidden="true" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-modal md:h-full">
                                        <div class="relative w-full h-full max-w-md md:h-auto">
                                            ...
                                            <div class="relative bg-white rounded-lg shadow ">
                                                ...
                                                <div class="px-6 py-6 lg:px-8">
                                                    <h3 class="mb-4 text-xl font-medium text-gray-900 ">¿Estás seguro de eliminar este paciente?<span class="font-light text-base"> Esta acción es irreversible y también significa eliminar la cuenta personal del paciente.</span></h3>
                                                    <form class="space-y-6" action="" method="post" >
