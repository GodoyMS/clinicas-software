...
*/
        ...
        if(isset($_POST['submitSolicitarCita'])){
        ...
        if(isset($_POST['submitSolicitarCita'])){
            ...
            $mensaje= 'El paciente '.$nombrePaciente.' ha solicitado una cita para el dia '.$inicio.' . El motivo de la consulta es: '.$consulta;

            date_default_timezone_set('America/New_York');
            $fecha=date("Y-m-d H:i");
            $direccion="pacienteAConsultorio";
            $tipoMensaje="Solicitud de cita";
    ...
    <div class="w-full max-w-md mx-auto">  
         <div class="px-7 bg-white shadow-lg  rounded-2xl ">
            <div class="flex flex-wrap">
                ...
                <div class="flex-1 group">
                    <a href="#" class="flex items-end justify-center text-center mx-auto px-4 pt-2 w-full text-blue-500 ">
                        <span class="block px-1 pt-1 pb-2">
                ...
                <div role="alert" class="container mx-auto w-11/12 md:w-2/3 max-w-lg">
                    <div class="relative py-8 px-5 md:px-10 bg-white dark:bg-gray-800 dark:border-gray-700 shadow-md rounded border border-gray-400">
                        ...
                        <div class="flex items-center justify-start w-full">
                            <button   type="submit" name="submitSolicitarCita" class="focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 transition duration-150 ease-in-out hover:bg-indigo-600 bg-indigo-700 rounded text-white px-8 py-2 text-sm">Solicitar cita</button>
