...
<section class="accounts">
   ...
   <h1 class="heading">Cuenta de administrador</h1>
   ...
   <div class="box">
      ...
      <div class="flex-btn">
         <a href="admin_accounts.php?delete=<?= $fetch_accounts['id']; ?>" class="delete-btn" onclick="return confirm('delete this account?');">Borrar</a>
         <?php
