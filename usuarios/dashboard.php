        ...
        <?php
            ...
            <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                ...
                if($fetchCitaPendienteTodo['estado']=="Por confirmar"){
                    echo '<td class="  px-6 py-4"><span class="px-2 py-1  leading-tight text-gray-800 bg-gray-100 rounded-full dark:bg-green-700 dark:text-green-100">'.$fetchCitaPendienteTodo["estado"].'</span></td>';
                };
                if($fetchCitaPendienteTodo['estado']=="Confirmado"){
                    echo '<td class="  px-6 py-4"><span class="px-2 py-1  leading-tight text-green-800 bg-green-200 rounded-full dark:bg-green-700 dark:text-green-100">'.$fetchCitaPendienteTodo["estado"].'</span></td>';
                };
                if($fetchCitaPendienteTodo['estado']=="Cancelado"){
                    echo '<td class="  px-6 py-4"><span class="px-2 py-1  leading-tight text-red-800 bg-red-200 rounded-full dark:bg-green-700 dark:text-green-100">'.$fetchCitaPendienteTodo["estado"].'</span></td>';
                };
                if($fetchCitaPendienteTodo['estado']=="Solicitud postergación"){
                    echo '<td class="  px-6 py-4"><span class="px-2 py-1  leading-tight text-yellow-800 bg-yellow-200 rounded-full dark:bg-green-700 dark:text-green-100">'.$fetchCitaPendienteTodo["estado"].'</span></td>';
                };
