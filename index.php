...
<head>
    ...
    <title>Alpha Clinicas XDDDD</title>
...
<body>
    ...
    <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
        ...
        <div class="mr-auto place-self-center lg:col-span-7">
            ...
            <p class="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">Software para gestión de información, pagos, citas, tratamientos, historial médico y mas.</p>
            <div class="flex justify-center ">
            <a href="registrarse.php" class="inline-flex items-center justify-center px-5 py-3 mr-3 text-base font-medium text-center text-white rounded-lg bg-blue-600 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:focus:ring-primary-900">
                Registra tu consultorio Ahora 
                <svg class="w-5 h-5 ml-2 -mr-1" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
            </a>
            <a href="software-odontologos.php" class="inline-flex items-center justify-center px-5 py-3 text-base font-medium text-center text-gray-900 border border-gray-300 rounded-lg hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 dark:text-white dark:border-gray-700 dark:hover:bg-gray-700 dark:focus:ring-gray-800">
                Conoce más
            </a> 
            </div>
        </div>
  ...
  <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
      <div class="max-w-screen-md mb-8 lg:mb-16 text-center mx-auto">
          <h2 class="mb-4 text-xl sm:text-3xl tracking-tight font-extrabold text-gray-900 dark:text-white ">Diseñado para profesionales de la salud</h2>
          <p class="text-gray-500 sm:text-xl dark:text-gray-400">Ofrecemos las siguientes funciones</p>
      </div>
      <div class="space-y-8 md:grid md:grid-cols-2 features  gap-12 md:space-y-0">
          <div class="bg-gray-50 rounded-lg p-4">
              <div class="flex mx-auto items-center mb-4 w-10 h-10 rounded-full bg-blue-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-white text-center">Agenda de digital</h3>
              <p class="text-gray-500 dark:text-gray-400">Control total de agenda, cancelación y postergación de horarios de citas a traves de una agenda digital.</p>
          </div>
          <div class="bg-gray-50 rounded-lg p-4">
              <div class="flex mx-auto items-center mb-4 w-10 h-10 rounded-full bg-blue-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-white text-center">Registros clinicos</h3>
              <p class="text-gray-500 dark:text-gray-400">Registro de historia clínica y consentimientos informados por cada paciente</p>
          </div>
          ...
          <div class="bg-gray-50 rounded-lg p-4">
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-white text-center">Laboratorio virtual de odontogramas</h3>
              <p class="text-gray-500 dark:text-gray-400">Deja de lado los papeles y lapiceros y prueba nuestra interfaz de generación de odontogramas digital</p>
          </div>
          <div class="bg-gray-50 rounded-lg p-4">
              <div class="flex mx-auto items-center mb-4 w-10 h-10 rounded-full bg-blue-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-white text-center">Canal de chat con pacientes </h3>
              <p class="text-gray-500 dark:text-gray-400">Mantente conectado en todo momento con tus pacientes a través de un canal de chat con tus pacientes afiliados</p>
          </div>
          <div class="bg-gray-50 rounded-lg p-4">
              <div class="flex mx-auto items-center mb-4 w-10 h-10 rounded-full bg-blue-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              <svg class="w-8 h-8 flex mx-auto text-blue-600" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-white text-center">Control y registro de costos </h3>
              <p class="text-gray-500 dark:text-gray-400">Obten el control de los ingresos y egresos a traves de un reporte mensual automático</p>
          </div>
          <div class="bg-gray-50 rounded-lg p-4">
              <div class="flex mx-auto items-center mb-4 w-10 h-10 rounded-full bg-blue-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              <svg  class="w-8 h-8 flex mx-auto text-blue-600" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-white text-center">Aplicativo web para tus pacientes</h3>
              <p class="text-gray-500 dark:text-gray-400">Afilia a tu paciente y proveele con una cuenta digital para mantener un control total de los procesos y documentos</p>
          </div>
    ...
    <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
        <div class="mx-auto max-w-screen-sm text-center  ">
            ...
            <a href="registrarse.php" class="text-white bg-blue-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800">Prueba gratis por 15 dias</a>
        </div>
    </div>
</section>
