...
if(isset($_POST['submit_login'])){
   ...
   $select_user = $conn->prepare("SELECT * FROM `usuarios` WHERE dni = ? AND contraseña = ?");
...
<div class="relative min-h-screen flex ">
    <div class="flex flex-col sm:flex-row items-center md:items-start sm:justify-center md:justify-start flex-auto min-w-0 bg-white">
      <div class="sm:w-1/2 xl:w-3/5 h-full hidden md:flex flex-auto items-center justify-center p-10 overflow-hidden bg-purple-900 text-white bg-no-repeat bg-cover relative"
        style="background-image: url(images/jonathan-borba-Yui-VjmS8AA-unsplash.jpg);">
        ...
        <div class="w-full  max-w-md z-10">
          ...
          <div class="sm:text-xl text-gray-200 font-normal"> Clinicas</div>
        </div>
        <!---remove custom style-->
       <ul class="circles">
      <li></li>
      ...
      <div class="md:flex md:items-center md:justify-center pt-14 sm:w-auto md:h-full w-4/5 xl:w-2/5 p-4  md:p-10 lg:p-14 sm:rounded-lg md:rounded-none bg-white">
        <div class="max-w-md w-full space-y-8">
          ...
          <div class="text-center">
            ...
            <span class="text-gray-400 font-normal">Alpha Clinicas | Clínicas</span>
            <span class="h-px w-16 bg-gray-200"></span>
          </div>
          ...
          <form class="mt-8 space-y-6" action="" method="POST">
            <div class="relative">
              ...
              <input
                ...
                type="text"  id="dni" name="dni" maxlength="8" placeholder="78102984"  value="<?php if(isset($_COOKIE["dni"])) { echo $_COOKIE["dni"]; } ?>">
            </div>
            ...
            <p class="flex flex-col items-center justify-center mt-10 text-center text-md text-gray-500">
              ...
              <a href="registrarse.php"
                class="text-indigo-400 hover:text-blue-500 no-underline hover:underline cursor-pointer transition ease-in duration-300">Registra tu consultorio</a>
            </p>
          </form>
        </div>
      </div>
