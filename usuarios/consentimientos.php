    ...
    <div class="w-full max-w-md mx-auto">  
         <div class="px-7 bg-white shadow-lg  rounded-2xl ">
            <div class="flex flex-wrap">
                ...
                <div class="flex-1 group">
                    <a href="consentimientos.php" class="flex items-end justify-center text-center mx-auto px-4 pt-2 w-full text-blue-500  ">
                        <span class="block px-1 pt-1 pb-2">
...
<!--DISPLAY HISTORIAL CONSENTIMIENTOS-->

<section>
<h2 class="text-lg  text-center text-gray-500    ">Historial de consentimientos</h2>
<span class="block w-72 mx-auto h-1 rounded-full bg-blue-500"></span>
...
<div class="p-4 relative overflow-x-auto  sm:rounded-lg">
    ...
    <table style="max-width:50rem;" class="w-full  rounded-full shadow-lg mx-auto text-sm text-left text-gray-500 dark:text-gray-400">
                              ...
                              $showConsentimiento->execute([$userPaciente_id]);
                                ...
                                while ($fetchConsentimiento = $showConsentimiento->fetch(PDO::FETCH_ASSOC)) { 
                                  ...
                                  <tr class="bg-white dark:bg-gray-900 hover:bg-gray-50 dark:hover:bg-gray-600">
                                      ...
                                      <td scope="row" class="flex tems-center px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                          <a  target="_blank" href="../panel/consentimientos/<?=$fetchConsentimiento['doc'];?>">
