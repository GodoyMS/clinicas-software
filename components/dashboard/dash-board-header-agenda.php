...
<div class="fixed w-full flex items-center justify-between h-14 text-white z-10">
        <div class="flex items-center justify-start md:justify-center pl-3 w-14 md:w-64 h-14 bg-blue-600 dark:bg-gray-800 border-none">
                    ...
                    <li class="p-2 ">
                          <a href="">
                                ...
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-3 text-sm font-normal">
                                        <div class="text-sm font-semibold text-gray-900 dark:text-gray-100 ">Aun no tienes niguna notificación</div>
                                    </div>
                                </div> 
                          </a>                 
                  </li>
