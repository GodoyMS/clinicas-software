...
<h3 class="mb-4 text-2x1 font-bold text-gray-900 dark:text-white">Iniciar sesión a nuestra plataforma</h3>

                    <div>
                        <label for="dni" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">DNI</label>
                        <input maxlength="8" minlength="8" type="" oninput="validationDNI();" id="dni" name="dni"  placeholder="711022131" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" required>
                    </div>
                    <div>
                    ...
                    <button type="submit" value="login now" name="submitLoginPacientes" class="w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Entrar a tu cuenta</button>
                    <div class="text-sm font-medium text-gray-500 dark:text-gray-300">
                        ¿Aun no estas registrado? <a href="registrar.php" class="text-blue-700 hover:underline dark:text-blue-500">Afiliate y registrate a tu clinica o consultorio</a>
                    </div>
                </form>
