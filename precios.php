...
<section class="bg-white dark:bg-gray-900">
  <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
      <div class="mx-auto max-w-screen-md text-center mb-8 lg:mb-12">
          <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Diseñado para especialistas como tu</h2>
          <p class="mb-5 font-light text-gray-500 sm:text-xl dark:text-gray-400">Aqui en Alpha-Clinicas nos enfocamos en brindarte absolutamente todas las funciones y características de nuestro software por un precio unico. Elige el periodo que mas se acomode a tus necesidades</p>
          <p class="mb-5 font-light text-gray-500 sm:text-xl dark:text-gray-400">Nótese que para empezar con cualquiera de los planes, es importante que cree una cuenta, podrás realizar el pago desde tu mismo panel de administración en tu cuenta. Obtendrás <strong> acceso gratis por 15 días </strong>, puedes comprar cualquiera de estos planes antes o despúes de estos 15 días. La fecha de inicio de tu plan comenzará despues que haya vencido tu prueba gratuita</p>
      </div>
      <div class=" prices-cards grid gap-8 ">
          ...
          <div class="flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-100 shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
              ...
              <p class="font-light text-gray-500 sm:text-lg dark:text-gray-400">Ahorra 33.33%</p>
              <div class="flex justify-center items-baseline my-8">
          ...
          <div class="flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-100 shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
              ...
              <p class="font-light text-gray-500 sm:text-lg dark:text-gray-400">Ahorra 41.6%</p>
              <div class="flex justify-center items-baseline my-8">
