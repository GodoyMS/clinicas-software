...
<div x-data="setup()" :class="{ 'dark': isDark }">
    <div class="min-h-screen flex flex-col flex-auto flex-shrink-0 antialiased bg-white dark:bg-gray-700 text-black dark:text-white">
      ...
      <!--INICIA CONTENIDO-->    
      <div class="h-full ml-14 mt-14 bg-gray-50 dark:bg-gray-700 mb-10 md:ml-64">
      ...
      <!---->
        ...
        <div class="grid grid-cols-1 lg:grid-cols-1 p-4 gap-4">
          ...
          <!-- Social Traffic -->
          <div style="m" class="relative mx-auto flex flex-col min-w-0 mb-4 lg:mb-0 break-words bg-gray-50 dark:bg-gray-800 w-full shadow-lg rounded">
            <div class="rounded-t mb-0 px-0 border-0">
              <div class="flex flex-wrap items-center px-4 py-2">
                <div class="relative w-full max-w-full flex-grow flex-1">
                  <h3 class="font-semibold text-base text-gray-900 dark:text-gray-50">Citas este mes</h3>
                </div>
                <div class="relative w-full max-w-full flex-grow flex-1 text-right">
                  <a  href="citas.php"class="bg-blue-500 dark:bg-gray-100 text-white active:bg-blue-600 dark:text-gray-800 dark:active:text-gray-700 text-xs font-bold uppercase px-3 py-1 rounded outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150" >Ver más</a>
                </div>
              </div>
              <div class="block w-full overflow-x-auto">
                <table class="items-center w-full bg-transparent border-collapse">
                  <thead>
                    <tr>
                      <th class="px-4 bg-gray-100 dark:bg-gray-600 text-gray-500 dark:text-gray-100 align-middle border border-solid border-gray-200 dark:border-gray-500 py-3 text-xs uppercase border-l-0 border-r-0 whitespace-nowrap font-semibold text-left">Paciente</th>
                      ...
                      <th class="px-4 bg-gray-100 dark:bg-gray-600 text-gray-500 dark:text-gray-100 align-middle border border-solid border-gray-200 dark:border-gray-500 py-3 text-xs uppercase border-l-0 border-r-0 whitespace-nowrap font-semibold text-left min-w-140-px">Fecha</th>
                    </tr>
                  </thead>
                  <tbody>
                    <?php
         ...
         <!--DOCTORES-->
    <h3 class="font-semibold mt-10 text-2xl text-center text-gray-900 dark:text-gray-50">Profesionales</h3>
    <span class="block w-48 mx-auto h-1 rounded-full dark:bg-gray-500 bg-blue-500"></span>      <?php
         //FETCH DOCTORES
        ...
        <div style="" class=" mx-auto grid py-8 grid-cols-2 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-4 px-4 ">
          ...
          ?>
              <div class="w-full   bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">                  
                  ...
                  <div class="flex flex-col items-center pb-4 pt-4">
                      ...
                      <h5 class="mb-1 text-xs md:text-base font-medium text-gray-900 dark:text-white"><?=$fetchDoctores['nombre'];?></h5>
                      <span class="text-sm text-gray-500 px-1 dark:text-gray-400"><?=$fetchDoctores['especialidad'];?></span>
                      <div class="flex mt-4 flex-wrap justify-center space-x-3 md:mt-6">
                          <a href="mailto:<?=$fetchDoctores['correoDoctor'];?>"  target="_blank" class="inline-flex bg-gray-100 items-center px-2 py-2 text-sm font-medium text-center text-white rounded-full dark:bg-gray-600 dark:hover:bg-gray-500 hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-blue-300  dark:focus:ring-blue-800">
                          ...
                          <a href="https://api.whatsapp.com/send?phone=<?=$fetchDoctores['telefonoDoctor'];?>" target="_blank" class="inline-flex items-center px-2 py-2 text-sm font-medium text-center bg-gray-10  text-gray-900 rounded-full dark:hover:bg-gray-500  hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-200 dark:bg-gray-600 dark:text-white dark:border-gray-600  dark:focus:ring-gray-700">
         ...
         <?php
          ...
          echo '<div style="max-width:24rem" class="p-4 mx-auto mt-4  mb-10 text-sm text-gray-800 rounded-lg bg-gray-50 dark:bg-gray-800 dark:text-gray-300" role="alert">
        ...
        <div class="mt-8 mx-4">
          <div class="grid grid-cols-1 lg:grid-cols-2">
            <div class="p-6 mr-2 bg-gray-100 dark:bg-gray-800 sm:rounded-lg">
              <h1 class="text-4xl sm:text-5xl text-gray-800 dark:text-white font-extrabold tracking-tight">Contáctanos</h1>
              <p class="text-normal text-lg sm:text-2xl font-medium text-gray-600 dark:text-gray-400 mt-2">Completa el formulario para enviar tu mensaje</p>
            ...
            <div class="flex items-center gap-4">
                <label for="destinatario" class="text-gray-700 font-semibold dark:text-gray-300">Para:</label>
                <input type="email" name="destinatario" id="destinatario" disabled value="alphaclinicas.business@gmail.com" class="w-full mt-2 py-3 px-3 rounded-lg bg-white dark:bg-gray-800 border border-gray-400 dark:border-gray-700 text-gray-800 dark:text-gray-50 font-semibold focus:border-blue-500 focus:outline-none" />
              </div>
              <div class="flex flex-col">
                <label for="name" class="hidden">Nombres</label>
                <input type="name" name="name" id="name" placeholder="Nombres" class="w-100 mt-2 py-3 px-3 rounded-lg bg-white dark:bg-gray-800 border border-gray-400 dark:border-gray-700 text-gray-800 dark:text-gray-50 font-semibold focus:border-blue-500 focus:outline-none" />
              </div>
              ...
              <div class="flex flex-col mt-2">
                ...
                <textarea  name="mensaje" id="tel" placeholder="Mensaje" rows="3" class="w-100 mt-2 py-3 px-3 rounded-lg bg-white dark:bg-gray-800 border border-gray-400 dark:border-gray-700 text-gray-800 dark:text-gray-50 font-semibold focus:border-blue-500 focus:outline-none" ></textarea>
              </div>
    
              <button type="submit" class="md:w-32 bg-blue-600 dark:bg-gray-100 text-white dark:text-gray-800 font-bold py-3 px-6 rounded-lg mt-4 hover:bg-blue-500 dark:hover:bg-gray-200 transition ease-in-out duration-300">Enviar</button>
            </form>
          </div>
        </div>
        <!-- ./Contact Form -->
