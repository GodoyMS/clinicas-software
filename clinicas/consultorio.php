...
<div x-data="setup()" :class="{ 'dark': isDark }">
    <div class="min-h-screen flex flex-col flex-auto flex-shrink-0 antialiased bg-white dark:bg-gray-700 text-black dark:text-white">
      ...
      <div class="h-full ml-14 mt-14 mb-10 md:ml-64">
            ...
            <div style="max-width:600px;margin:4rem auto 0 auto" class="   p-4 mx-4 rounded-lg  bg-gray-50 dark:bg-gray-800" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                    ...
                    <form action=""  method="post" class="px-2 py-4">
                            <div class="py-4">
                                ...
                                <input type="name" name="nombreConsultorio"  value="<?=$fetch_clinica['nombreConsultorio'];?>" id="nombrePaciente" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Susana Mendoza" required>
                            </div>

                                    <div class="py-4">

                                        <label for="nombrePaciente" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Especialidad</label>
                                        <input type="text" name="especialidad"  value="<?=$fetch_clinica['especialidad'];?>" id="nombrePaciente" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Susana Mendoza" required>
                                    </div>
                                    <div class="grid gap-6 mb-6 md:grid-cols-2">
                                    <div>

                                        <label for="nombrePaciente" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Departamento</label>
                                        <input type="city" name="departamento"  value="<?=$fetch_clinica['departamento'];?>" id="nombrePaciente" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Susana Mendoza" required>
                                    </div>
                                    
                                    <div>
                                        <label for="telefonoPaciente" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Provincia </label>
                                        <input type="text" name="provincia"value="<?=$fetch_clinica['provincia'];?>"id="telefonoPaciente" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="913411231" required>
                                    </div>  
                                    <div>
                                        <label for="edadPaciente" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Distrito</label>
                                        <input type="text" name="distrito" id="edadPaciente"  value="<?=$fetch_clinica['distrito'];?>"class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="12"  required>
                                    </div>
                                    <div>
                                        <label for="ciudadPaciente" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Numero de consultorio</label>
                                        <input type="tel" name="numeroConsultorio" id="ciudadPaciente" value="<?=$fetch_clinica['numeroConsultorio'];?>" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Huancavelica" >
                                    </div>
                                    <div>
                                        <label for="emailPaciente" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Email de Consultorio</label>
                                        <input type="email" name="emailConsultorio" id="emailPaciente"  value="<?=$fetch_clinica['emailConsultorio'];?>"class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="godoy@gmail.com"  >
                                    </div>    
                            </div>
                            <div class="py-4">
                        ...
                        <button type="submit" name="submitActualizarInfoConsultorio" class="text-white  bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Actualizar</button>
                    </form>
